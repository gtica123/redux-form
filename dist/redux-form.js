...
var _lodash = _interopRequireDefault(__webpack_require__(/*! lodash.mapvalues */ "./node_modules/lodash.mapvalues/index.js"));
...
var getFieldWarnAndValidate = function getFieldWarnAndValidate(prop, name) {
  return Array.isArray(prop) || typeof prop === 'function' ? prop : (0, _lodash["default"])(prop, name, undefined);
};
...
var _lodash2 = _interopRequireDefault(__webpack_require__(/*! lodash.isequal */ "./node_modules/lodash.isequal/index.js"));

var _lodash3 = _interopRequireDefault(__webpack_require__(/*! lodash.mapvalues */ "./node_modules/lodash.mapvalues/index.js"));
    ...
    return function (Component) {
      var FormValues = /*#__PURE__*/function (_React$Component) {
        ...
        _proto.updateComponent = function updateComponent(props) {
          ...
          if ((0, _lodash["default"])(valuesMap)) {
          ...
          if ((0, _lodash2["default"])(valuesMap, this._valuesMap)) {
        ...
        _proto.setComponent = function setComponent() {
          ...
          var formValuesSelector = function formValuesSelector(_, _ref2) {
            ...
            return (0, _lodash3["default"])(_this2._valuesMap, function (path) {
...
function createReducer(structure) {
  ...
  var behaviors = (_behaviors = {}, _behaviors[_actionTypes.ARRAY_INSERT] = function (state, _ref2) {
    ...
    if (initial === undefined && payload === '' || payload === undefined) {
      result = deleteInWithCleanUp(result, "values." + field);
    } else if ((0, _lodash["default"])(payload)) {
...
var _lodash2 = _interopRequireDefault(__webpack_require__(/*! lodash.merge */ "./node_modules/lodash.merge/index.js"));
  ...
  return function (initialConfig) {
    ...
    return function (WrappedComponent) {
          ...
          _this.validateIfNeeded = function (nextProps) {
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge = (0, _lodash2["default"])(validate ? validate(propsToValidate.values, propsToValidate) || {} : {}, fieldLevelValidate ? fieldLevelValidate(propsToValidate.values, propsToValidate) || {} : {}),
                    _error = _merge._error,
                    nextSyncErrors = (0, _objectWithoutPropertiesLoose2["default"])(_merge, ["_error"]);
          ...
          _this.warnIfNeeded = function (nextProps) {
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge2 = (0, _lodash2["default"])(warn ? warn(propsToWarn.values, propsToWarn) : {}, fieldLevelWarn ? fieldLevelWarn(propsToWarn.values, propsToWarn) : {}),
                    _warning = _merge2._warning,
                    nextSyncWarnings = (0, _objectWithoutPropertiesLoose2["default"])(_merge2, ["_warning"]);
      ...
      var connector = (0, _reactRedux.connect)(function (state, props) {
        ...
        var boundFormACs = (0, _lodash["default"])(formActions, bindForm);
        var boundArrayACs = (0, _lodash["default"])(arrayActions, bindForm);
...
var _lodash = _interopRequireDefault(__webpack_require__(/*! lodash.topath */ "./node_modules/lodash.topath/index.js"));
  ...
  return function (shouldDelete) {
    ...
    var deleteInWithCleanUp = function deleteInWithCleanUp(state, path) {
      if (path[path.length - 1] === ']') {
        // array path
        var pathTokens = (0, _lodash["default"])(path);
        pathTokens.pop();
...
var deleteIn = function deleteIn(state, field) {
  return deleteInWithPath.apply(void 0, [state].concat((0, _lodash["default"])(field)));
};
...
var setIn = function setIn(state, field, value) {
  return setInWithPath(state, value, (0, _lodash["default"])(field), 0);
};
...
var shallowCompare = function shallowCompare(instance, nextProps, nextState) {
  var propsEqual = (0, _lodash["default"])(instance.props, nextProps, customizer);
  var stateEqual = (0, _lodash["default"])(instance.state, nextState, customizer);
