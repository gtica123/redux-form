          ...
          _this.validateIfNeeded = function (nextProps) {
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge = merge(validate ? validate(propsToValidate.values, propsToValidate) || {} : {}, fieldLevelValidate ? fieldLevelValidate(propsToValidate.values, propsToValidate) || {} : {}),
                    _error = _merge._error,
                    nextSyncErrors = _objectWithoutPropertiesLoose(_merge, ["_error"]);
          ...
          _this.warnIfNeeded = function (nextProps) {
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge2 = merge(warn ? warn(propsToWarn.values, propsToWarn) : {}, fieldLevelWarn ? fieldLevelWarn(propsToWarn.values, propsToWarn) : {}),
                    _warning = _merge2._warning,
                    nextSyncWarnings = _objectWithoutPropertiesLoose(_merge2, ["_warning"]);
